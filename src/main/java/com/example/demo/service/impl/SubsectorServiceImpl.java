...
import com.example.demo.repository.SubSectorRepo;
...
@Service
public class SubsectorServiceImpl implements ISubsectorService {

    SubSectorRepo repo;

    public SubsectorServiceImpl(SubSectorRepo ss){
        this.repo = ss;
    }
